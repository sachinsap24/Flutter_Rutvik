...
import 'package:matrimonial_app/Executive%20Ui/SignupScreen/adharcardback_screen.dart';
import 'package:matrimonial_app/ModelClass/Executive_ModelClass/uploadAdharcard_model.dart';
...
class AdharcardFront_screen extends StatefulWidget {
  const AdharcardFront_screen({Key? key}) : super(key: key);

  @override
  State<AdharcardFront_screen> createState() => _AdharcardFront_screenState();
}

class _AdharcardFront_screenState extends State<AdharcardFront_screen> {
  Dio dio = Dio();
  UploadAdharCardModel? adharCardModel;
        ...
        child: Column(
          children: [
            ...
            Container(
              height: height * 0.1,
              width: width,
              child: Image.asset(ImagePath.uploaddocument),
            ),
            SizedBox(
              height: 20,
            ),
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.push(context,
            CupertinoPageRoute(builder: (context) => AdharcardBack_screen()));
