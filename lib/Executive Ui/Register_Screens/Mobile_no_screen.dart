...
class _MobileNoScreenState extends State<MobileNoScreen> {
                    ...
                    children: [
                      ...
                      ECommonButton(
                          ...
                          btnOnTap: () {
                            ...
                            /* if (_mobile.text.length == 10 && check == true) {
  ...
  Future createUser(String _mobile, String password, String email) async {
    ...
    if (response.statusCode == 200) {
      var res = E_LoginModel.fromJson(jsonDecode(response.body));
      ...
      Fluttertoast.showToast(
          msg: "Register credentials are invalid.",
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM,
          timeInSecForIosWeb: 1,
          backgroundColor: Color(0xffEB4132),
      ...
      showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              content: Text(
                "Register credentials are invalid.",
  ...
  registerapi() async {
    ...
    final msg = {"mobile": _mobile.text.toString(), "otp": "123456"};
    ...
    if (response.statusCode == 200) {
      ...
      if (result["success"] == true) {
        ...
        prefs.setString(EXE_MOBILE, _registerSuccess.data!.mobile.toString());
        print(_registerSuccess.data!.mobile.toString());
        prefs.setString(EXE_ID, _registerSuccess.data!.id.toString());
