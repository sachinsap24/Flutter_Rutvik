...
class ExUploadPicture extends StatefulWidget {
  final String? isUpdate;
  final Function? onBack;
  var candidateId;
  ExUploadPicture({Key? key, this.isUpdate, this.onBack, this.candidateId})
      : super(key: key);

  @override
  State<ExUploadPicture> createState() => _ExUploadPictureState();
}

class _ExUploadPictureState extends State<ExUploadPicture> {
  ...
  void setCoverImage(String imageType, PickedFile? image) async {
    ...
    log("user id executive  ::: ${widget.candidateId}");
    ...
    try {
      ...
      var response = await dio.post(
          UPLODE_CANDIDATE_PROFILE_IMG + "?" + queryString,
          data: formData);
