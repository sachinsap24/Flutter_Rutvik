...
class E_Contact_Us extends StatefulWidget {
  const E_Contact_Us({Key? key}) : super(key: key);

  @override
  State<E_Contact_Us> createState() => _E_Contact_UsState();
}

class _E_Contact_UsState extends State<E_Contact_Us> {
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          body: Column(
            ...
            children: [
              CommonAppbar1(name: AppConstants.contactUs),
              Expanded(
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  hintStyle: TextStyle(
                                      color:
                                          Color(0xff333F52).withOpacity(0.5))),
                            ),
                          ),
                          SizedBox(height: 25),
                          Text(
